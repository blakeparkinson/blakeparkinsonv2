  ...
  <div className="resume-page">
    <div className="col-xs-12 col-md-11 col-md-centered col-lg-10 col-lg-push-1">
      <div className="heading text-center">
        <h1 class="heading-title">Blake Parkinson</h1>
        <h6 class="heading-subtitle">
          wizardplow@gmail.com • 415-205-0841
          <span className="spacer">• Boulder, CO</span>
        </h6>
      </div>
      <div className="row">
            ...
            <div className="position">
              <h4>
                ...
                <small className="resume-role">
                  {' '}
                  B.SC - COMPUTER SCIENCE & POLITICS MAJOR - 2007
                </small>
              </h4>
